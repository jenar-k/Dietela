describe('Ahli Gizi Menggunakan Fitur Lupa Password Dietela', () => {
    ...
    it('Ahli Gizi menggunakan fitur lupa password Dietela dengan data Email yang Tidak Valid', () => {
        cy.forgotPasswordPageDietela();
    ...
    it('Ahli Gizi menggunakan fitur lupa password Dietela dengan data Email (NULL)', () => {
        cy.forgotPasswordPageDietela();
        cy.get('[class="css-4kjjx2"]')
            .should('be.disabled')
    })
